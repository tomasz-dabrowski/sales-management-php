...
$sql = "SELECT order_id, order_date, customer_id, client_contact, payment_status FROM orders WHERE order_status = 1";
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="orders.php?o=edit&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
